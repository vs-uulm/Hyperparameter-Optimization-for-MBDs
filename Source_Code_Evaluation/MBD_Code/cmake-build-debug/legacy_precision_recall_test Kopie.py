...
def read_and_process_file(line):
    ...
    command = (
        ...
        f"-n {weight_args[6]} -o {weight_args[7]} -p {threshold} -q {iteration} "
    )
...
def run_optimization():
    ...
    with ThreadPoolExecutor(max_workers=n_threads) as executor:
        ...
        with open("mixed_pareto_front.json", 'r') as file:
            for line in file:
...
if __name__ == "__main__":
    ...
    write_list_to_file(results, "output_test.json")
